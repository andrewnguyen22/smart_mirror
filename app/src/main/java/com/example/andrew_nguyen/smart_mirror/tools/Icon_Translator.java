...
public class Icon_Translator {
    public Drawable translate(Context ctx, String icon_code, String description) {
        switch (icon_code) {
            case "01d":
                return ctx.getResources().getDrawable(R.mipmap.sunny);

            case "01n":
                return ctx.getResources().getDrawable(R.mipmap.starry);

            case "02d":
                return ctx.getResources().getDrawable(R.mipmap.few_clouds);

            case "02n":
                return ctx.getResources().getDrawable(R.mipmap.few_cloudsn);

            case "03d":
                return ctx.getResources().getDrawable(R.mipmap.scattered_clouds);
            ...
            case "13d":
                return ctx.getResources().getDrawable(R.mipmap.snow);
            ...
            case "50d":
                if (description.trim().equals("tornado")) {
                    ctx.getResources().getDrawable(R.mipmap.tornado);
                } else
                    return ctx.getResources().getDrawable(R.mipmap.haze);
                break;
            case "50n":
                if (description.trim().equals("tornado")) {
                    ctx.getResources().getDrawable(R.mipmap.tornado);
                } else
                    return ctx.getResources().getDrawable(R.mipmap.hazen);
                break;
            default:
                return ctx.getResources().getDrawable(R.mipmap.extreme);
        }
        return ctx.getResources().getDrawable(R.mipmap.extreme);
    }
    ...
    public Drawable rain_check(String description, Context ctx) {
        if (description.trim().equals("heavy intensity drizzle rain") ||
            ...
            return ctx.getResources().getDrawable(R.mipmap.medium_rain);
            ...
            return ctx.getResources().getDrawable(R.mipmap.heavy_rain);
            ...
            return ctx.getResources().getDrawable(R.mipmap.light_thunderstorm);
        } else if (description.trim().equals("ragged thunderstorm") ||
                description.trim().equals("heavy thunderstorm")) {
            return ctx.getResources().getDrawable(R.mipmap.medium_thunderstorm);
        } else {
            return ctx.getResources().getDrawable(R.mipmap.light_rain);
        }
    }
}
